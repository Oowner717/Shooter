...
export const CONTROLS = [
  ...
  ['ABILITIES', (n) => `PULSE and HAIL to begin with, ${n - 2} more to open. One tap each; each comes back on its own.`],
  ['UPGRADES', () => 'bytes buy them. Tap the green figure to spend them down the tree.'],
